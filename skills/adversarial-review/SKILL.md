...
# 3. 运行编排脚本
bash ~/.workbuddy/skills/adversarial-review/orchestrate.sh
```
...
```
~/.workbuddy/skills/adversarial-review/
├── SKILL.md              # 本文件：主入口
...
- 被骂记录参考：`~/.workbuddy/workspace/drafts/scolding-record.md`
- 傅盛写作风格参考：`~/.workbuddy/workspace/skills/wechat-article/SKILL.md`
